...
(function ($) {
	...
	if(isExists('#rounded-countdown')){
		var dd = new Date('2020/12/18');
		var ss = dd.getTime();
		console.log(dd, ss, $.now(), ss-$.now())
	...
	console.log(isExists('#normal-countdown'))
...
function countdownTime(){
	console.log(isExists('#clock'), 'clock')
	if(isExists('#clock')){
		$('#clock').countdown('2020/12/18', function(event){
			var $this = $(this).html(event.strftime(''
